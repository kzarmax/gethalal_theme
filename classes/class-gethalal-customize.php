...
if ( ! class_exists('Gethalal_Customize') ) {
	/**
	 * Customizer Settings.
	 *
	 * @since Get Halal 1.0
	 */
	class Gethalal_Customize {
		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'gethalal' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'gethalal' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'gethalal' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'gethalal' ),
						'full'    => esc_html__( 'Full text', 'gethalal' ),
					),
				)
			);
			...
			include_once get_theme_file_path( 'classes/class-gethalal-customize-color-control.php' ); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound

			// Register the custom control.
			$wp_customize->register_control_type('Gethalal_Customize_Color_Control');
			...
			$wp_customize->add_control(
				new Gethalal_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'gethalal' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
